...
import 'package:vloo_tv_v2/app/data/configs/singleton.dart';
import 'package:vloo_tv_v2/app/data/models/common/common_response.dart';
...
class RestAPI {
  ...
  Future<dynamic> postDataMethod(String url, Map<String, String> header,
  ...
  Future<dynamic> postRawDataMethod(
      String url, Map<String, String> header, dynamic params) async {
    Response response = await connect.post(url, params, headers: header);
...
//post request example
  Future<String?> postMultipartMethod(
    ...
    if (response.statusCode == 200 && commonResponse?.status == 200) {
      ...
      Singleton.errorResponse?.message =
